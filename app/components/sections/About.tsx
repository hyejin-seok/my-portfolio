          ...
          <div className="flex w-[95%] flex-col gap-5 rounded-lg font-medium dark:font-normal xs:w-[80%] md:text-lg lg:w-[45%]">
            <AnimationWrapper variants={fadeInUPVar}>
              ...
              <p>
                ...
                intense school years and personal commitments, I found my way
                back to coding in Vancouver, feeling as if it was meant
                to&nbsp;happen.{' '}
              </p>
              <p>
                I am detail-oriented and dedicated, with a strong work ethic.
                With a background in business administration and customer
                service, I excel at collaborating with colleagues and clients to
