        ...
        <div className="mb-12">
          ...
          <div className="flex gap-10 mt-8 text-4xl justify-center">
            <a
              ...
              className="relative transition-transform transform duration-500 hover:scale-110 hover:text-orange-500 dark:hover:text-orange-500"
            >
              <SiLinkedin />
              <span className="absolute inset-0 -m-3 border-4 border-double border-transparent rounded-full transition-all duration-500 hover:border-orange-500 dark:hover:border-orange-500"></span>
            </a>
            <a
