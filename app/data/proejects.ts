...
export const projects: ProjectType[] = [
  ...
  },
  {
    ...
    type: 'page',
    description:
      'My personal portfolio website not only showcases my skills and projects as a web developer but also highlights my design capabilities using Figma and Next.js. This site is a reflection of my personal style and technical expertise, featuring both functionality and aesthetics. \n\n [ Key Features ] \n -Dynamic Theme Switching: \n Toggle between dark and light modes for a comfortable viewing experience regardless of the environment or time of day. \n -Interactive Animations: \n Utilize Framer Motion, Tailwind CSS to create fluid, eye-catching animations that make the UI lively and engaging. \n -Scroll Buttons: \n Easy navigation with "Scroll Down" to move to the next section and "Scroll to Top" button that appears as you move away from the top. \n -Background Music: \n  An optional background music feature that users can turn on to enhance their experience while browsing through the portfolio.',
